...
Triangle::Triangle(double first_1 = 0, double second_2 = 0)
{
	first = first_1;
	second = second_2;
}
...
double my_sqrt(const Triangle& triangle) {
	return sqrt(triangle.first * triangle.first + triangle.second * triangle.second);
}
